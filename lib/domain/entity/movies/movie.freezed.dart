...
@JsonKey(name: 'id') int get id;@JsonKey(name: 'title') String get title;@JsonKey(name: 'poster_path') String? get posterPath;
...
@useResult
$Res call({
@JsonKey(name: 'id') int id,@JsonKey(name: 'title') String title,@JsonKey(name: 'poster_path') String? posterPath
});
...
class _Movie implements Movie {
  const _Movie({@JsonKey(name: 'id') required this.id, @JsonKey(name: 'title') required this.title, @JsonKey(name: 'poster_path') this.posterPath});
